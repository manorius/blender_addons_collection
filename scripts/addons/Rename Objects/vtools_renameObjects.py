...
class RNO_PN_RenamePanel(bpy.types.Panel):
    ...
    def draw(self,context):
        ...
        col = row.column()
        subrow = col.row()
        op_SelectionOrder = subrow.operator(RNO_PN_KeepSelectionOrder.bl_idname,RNO_PN_KeepSelectionOrder.bl_label)
        ...
        row = layout.row()
        box = row.box()
        box.operator(RNO_OP_copyNameToDataName.bl_idname, RNO_OP_copyNameToDataName.bl_label)
